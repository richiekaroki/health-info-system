...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.aliases.Client' => 'string',
            'app.aliases.Program' => 'string',
            ...
            'filesystems.links.F:\Program Files\XAMPP\htdocs\health-info-system\public\storage' => 'string',
            ...
            'l5-swagger.documentations.default.paths.docs' => 'string',
...
'delete','enroll','unenroll','denyWithStatus','denyAsNotFound',
'viewClients',);
...
'app.aliases.Client','app.aliases.Program','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'filesystems.links.F:\\Program Files\\XAMPP\\htdocs\\health-info-system\\public\\storage','l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.routes.api','l5-swagger.documentations.default.paths.docs',
...
'l5-swagger.default.api','l5-swagger.default.docs','l5-swagger.default.asset','l5-swagger.default.oauth2_callback','sanctum.csrf-cookie','login','login.submit','register','logout','api.v1.register',
'api.v1.login','api.v1.logout','api.v1.test-auth','api.v1.clients.index','api.v1.clients.store',
'api.v1.clients.show','api.v1.programs.index','api.v1.programs.store','api.v1.programs.show','api.v1.programs.clients',
'api.v1.enrollments.enroll','api.v1.enrollments.unenroll','storage.local',);
        registerArgumentsSet('views', 
'dashboard','l5-swagger::index','vendor.l5-swagger.index','welcome','l5-swagger::index',
...
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded',
'F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','F:.Program Files.XAMPP.htdocs.health-info-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'APP_TIMEZONE','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER',
'DB_CONNECTION','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT','CACHE_DRIVER',
'QUEUE_CONNECTION','BROADCAST_DRIVER','VITE_REVERB_APP_KEY','VITE_REVERB_PORT','VITE_REVERB_SCHEME',
'PUSHER_HOST','PUSHER_PORT','PUSHER_SCHEME','L5_SWAGGER_CONST_HOST','L5_SWAGGER_GENERATE_ALWAYS',
'L5_SWAGGER_UI_DARK_MODE','L5_SWAGGER_OPEN_API_SPEC_VERSION','L5_SWAGGER_UI_DOC_EXPANSION','L5_SWAGGER_UI_PERSIST_AUTHORIZATION','SANCTUM_STATEFUL_DOMAINS',
'SANCTUM_TOKEN_PREFIX','SANCTUM_EXPIRATION','LOG_CHANNEL','LOG_STACK','LOG_DEPRECATIONS_CHANNEL',
'LOG_LEVEL','MAIL_MAILER','MAIL_HOST','MAIL_PORT','MAIL_USERNAME',
'MAIL_PASSWORD','MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','PASSWORD_RESET_TIMEOUT',
'VITE_APP_URL','VITE_APP_NAME','VITE_PUSHER_APP_KEY','VITE_PUSHER_APP_CLUSTER','PHP_CLI_SERVER_WORKERS',
'BCRYPT_ROUNDS','FILESYSTEM_DISK','API_URL',);
